...
public class MathConst {
  ...
  public static final double[] HEXAGON_POINTS_ANGLE_SIN = new double[] {
      Math.sin(0D * MathConst.HEXAGON_POINTS_ANGLE),
      Math.sin(1D * MathConst.HEXAGON_POINTS_ANGLE),
  ...
  public static final double[] HEXAGON_POINTS_ANGLE_COS = new double[] {
      Math.cos(0D * MathConst.HEXAGON_POINTS_ANGLE),
      Math.cos(1D * MathConst.HEXAGON_POINTS_ANGLE),
